...
function NGO_Cause(props) { 
  const columns = [
    ...
    },
    {
      ...
      width: 200,
      render: () => <div>
         <a><span class="btn btn-info btn-sm para">
                    <i class="fas fa-edit text-white"></i>
                  </span></a>
                  <a><span class="btn btn-warning btn-sm para">
                    <i class="fas fa-pause-circle text-white"></i>
                  </span></a>
                  <a><span class="btn btn-danger btn-sm para">
        ...
        <section className="content bg-white">
          ...
          <div class="row filterbox">
            ...
            <NavLink to="" className="nav-link">
              <button className="btnnca btn-orange btn-sm para">
          ...
          >
            ...
            <tbody>
              <tr>
                ...
                <td>
                <NavLink to="" className="nav-link"><span class="btn btn-info btn-sm para">
                    <i class="fas fa-edit"></i>
                  </span></NavLink>
                  <NavLink to="" className="nav-link"><span class="btn btn-danger btn-sm para">
                    <i class="fas fa-times-circle"></i>
                  </span></NavLink>
                  <NavLink to="" className="nav-link"><span class="btn btn-warning btn-sm para">
