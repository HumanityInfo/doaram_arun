          ...
          <div className="row ">
            <div className=" wow fadeIn" data-wow-delay="0.5s">
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                standards to provide you with secure transactions and take
                responsibility to guard your private information. Please read
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                us. The Policy may be subject to further changes. Upon updating
                the Policy, we may revise the “Updated” date at the top of this
                Policy. Your continued use of the Website and the services
                offered therein will imply your acceptance of such updates on
                this Policy. This Privacy Policy is incorporated into and
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                personal and non-personal information. 'Personal Information' is
              ...
              <ul>
                ...
                <li>Filling in any form available on the Website</li>
                <li>
                  Volunteering for any activity offered through the Website
                </li>
                <li>Creating a fundraiser on the Website</li>
                <li>
                  Providing financial information while making an online
                  donation or contribution
                </li>
                <li>Uploading or sharing content</li>
                <li>Participating in any online survey or contest</li>
                <li>
                  Communicating with DoAram by phone, email, chat or otherwise
                  in relation to the activities or services offered by DoAram.
                </li>
                <li>
                  DoAram may also collect Non-Personal Information such as your
                  location, the details of the device from which you access the
                  Website, Your URL or the IP address from where the Website is
                  accessed, the type of browser used by you, and/ or the User
                  history.
                </li>
              </ul>
              <p className="fw-medium text-dark mb-2">
              ...
              <ul>
                <li>Enable Your use of the Website</li>
                <li>Understand Your interest</li>
                <li>Provide a better user experience</li>
                <li>
                  Notify You about our updated information, activities, and
                  other related information
                </li>
                <li>Respond to Your queries</li>
                <li>
                  Help address any problems You may have incurred during the use
                  of the Website or the activities/ services offered therein
                </li>
                <li>
                ...
                <li>Facilitate Your making the donations or contribution</li>
                <li>
                  Conduct internal reviews and data analysis for the Website to
                  improve our activities provided through the Website
                </li>
                <li>
                  Gather broad demographic information such as your location
                </li>
                <li>
                  Analyze Your behavior, specifically in connection with
                  collecting information about Your donating or contributing
                  preferences and patterns
                </li>
                <li>Connect you with the NGO’s listed on the Website</li>
                <li>
                  Share information with any of our group of affiliate entities,
                ...
                <li>
                  ...
                  activities, to detect and prevent identity theft, suspected
                  fraud, violations of the Website or as otherwise required by
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                and Your interaction with our services. No personally
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                beneficiaries (eg. nonprofits) of your donations / contributions
                for compliance purposes and to ensure that campaign creators are
                able to provide you the rewards that you may have paid for.
                Although our website allows donors to be shown as Anonymous if
                selected, DoAram, payment gateway providers, and the chosen
                beneficiary (non-profit) will know of your true identity. If you
                choose a reward but chose to be shown as "Anonymous", a campaign
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                jurisdiction to any other countries and jurisdictions across the
                world (including India), with affiliates / agent / third party
                service provider / partners and other agencies for purposes
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                alert You when DoAram attempts to send you a cookie with an
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                internet is not 100% secure we cannot provide any absolute
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                website, and we may take all reasonable efforts to incorporate
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                Personal Information or withdraw the consent to provide us
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                by DoAram as specified under this Privacy Policy. You further
                consent to and authorise DoAram to share and transfer any or all
                of Your Personal Information and Non-Personal Information across
                borders across the world as specified under this Privacy Policy.
                You further agree that such sharing and transfer of Your
                Personal Information and Non-Personal Information shall not
              ...
              <p className="fw-medium text-dark mb-2">
                ...
                questions, comments or concerns including those pertaining to
             ...
             <h6 className="fw-medium txt-warning mb-2">DND Policy</h6>
              <p className="fw-medium text-dark mb-2">
                ...
                info@doaram.com with your mobile numbers and you will be
