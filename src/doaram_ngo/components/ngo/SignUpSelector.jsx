              ...
              <form id="msform" name="msform" method="POST" autocomplete="off">
                    ...
                    <div className="container mt-1 mb-1 text-start">
                      ...
                      <div className="input-group input-file">
                        ...
                        <span className="input-group-btn">
                          <label
                            className="btn btnnca btn-default"
                            type="button"
                          ...
                          <label
                            className="btn btnnca btn-default btn-reset"
                            type="button"
                          >
                ...
                <fieldset>
                  ...
                  <button
                    type="button"
                    name="previous"
                    className="previous btn btnnca btn-outline-secondary btn-sm w-25"
                    value="Previous"
                  >
                    {" "}
                  ...
                  <button
                    ...
                    name="SubmitDetail"
                    id="SubmitDetail"
                    className="btn btnnca btn-gold btn-sm w-25"
                  >
